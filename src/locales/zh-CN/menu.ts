export default {
  ...
  'menu.administration.ai-governance.audit': '审计中心',
  'menu.administration.ai-governance.data-tasks': '数据治理',
  'menu.welcome': '模板欢迎页',
  ...
  'menu.sales.return-new': '新建销售退货',
  'menu.sales.refund-review': '销售退款审核',
  'menu.purchase': '采购查询',
  'menu.purchase.orders': '采购订单',
  'menu.purchase.order-new': '新建采购订单',
  'menu.purchase.order-edit': '编辑采购订单',
  ...
  'menu.purchase.return-new': '新建采购退货',
  ...
  'menu.finance': '财务概览',
  'menu.printing': '打印中心',
  'menu.printing.batches': '批量打印任务',
  'menu.printing.history': '打印历史',
