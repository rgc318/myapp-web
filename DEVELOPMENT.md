...
- The web foundation now has real JWT login, dashboard, sales order query/detail/create/edit, purchase order query/detail, reporting entry, payment list, finance lookup, inventory lookup, and master-data lookup pages.
