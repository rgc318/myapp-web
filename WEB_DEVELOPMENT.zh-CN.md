...
- `src/components/PartyManagementPage.tsx`
  - 客户 / 供应商共用往来单位治理页面，支持关键词、状态、分组筛选、新增、编辑、启用、停用、详情抽屉、主联系人 / 主地址维护、当前筛选结果 CSV 导出和 CSV 批量导入。
...
- `/master-data/customers` 已接入客户治理第一版，支持关键词 / 状态 / 分组筛选、分页查询、新增、编辑、启用、停用、详情抽屉、主联系人 / 主地址维护、最近使用地址展示、当前筛选结果 CSV 导出和 CSV 批量导入。
- `/master-data/suppliers` 已接入供应商治理第一版，支持关键词 / 状态 / 分组筛选、分页查询、新增、编辑、启用、停用、详情抽屉、主联系人 / 主地址维护、最近使用地址展示、当前筛选结果 CSV 导出和 CSV 批量导入。
...
- 客户管理当前已从轻量维护升级为企业级第一版；尚未接入联系人 / 地址多条独立管理、信用额度、账期、税务信息、客户交易历史聚合、应收钻取、客户标签 / 区域 / 业务员归属和审计记录。
- 供应商管理当前已从轻量维护升级为企业级第一版；尚未接入联系人 / 地址多条独立管理、付款条款、税务信息、采购历史聚合、应付钻取、供应商等级 / 标签和审计记录。
