...
- `/sales/orders/:name` 已接入订单详情、金额汇总、履约信息、关联发货单 / 发票和商品明细，并支持按日期和备注创建发货单、创建销售发票、按金额和付款方式登记收款、取消销售订单。
...
- `/purchase/orders/:name` 已接入采购订单详情、金额汇总、基本信息、供应商信息、关联收货单 / 发票和商品明细，并支持按日期和备注创建收货单、创建采购发票、按金额和付款方式登记付款、取消采购订单。
...
- 销售 / 采购订单详情已接入按日期和备注创建发货 / 收货单、创建发票、按金额和付款方式登记收付款、取消订单动作。
